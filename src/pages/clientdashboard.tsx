...
export default function ClientDashboard({ profile }: { profile: any }) {
  ...
  <span style={{ fontSize: 20 }}>✉️</span> Email Nischelee
</a>
<a href="mailto:denielle@precisionpostcleaningco.com" style={{ display: 'flex', alignItems: 'center', gap: 12, background: C.offWhite, border: `1px solid ${C.border}`, borderRadius: 10, padding: '14px 18px', color: C.navy, textDecoration: 'none', fontWeight: 600, fontSize: 14 }}>
